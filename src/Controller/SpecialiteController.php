...
class SpecialiteController extends AbstractController
{
    ...
    {
        return $this->render('specialite/index.html.twig', ['specialites' => $specialiteRepository->findAll()]);
    }
    ...
    {
        return $this->render('specialite/show.html.twig', ['specialite' => $specialite]);
    }
    ...
    public function edit(Request $request, Specialite $specialite): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('specialite_edit', ['id' => $specialite->getId()]);
        }
