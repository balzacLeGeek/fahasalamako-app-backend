...
class AstucesController extends AbstractController
{
    ...
    {
        return $this->render('astuces/index.html.twig', ['astuces' => $astucesRepository->findAll()]);
    }
    ...
    {
        return $this->render('astuces/show.html.twig', ['astuce' => $astuce]);
    }
    ...
    public function edit(Request $request, Astuces $astuce): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('astuces_edit', ['id' => $astuce->getId()]);
        }
