...
class RendezvousController extends AbstractController
{
    ...
    {
        return $this->render('rendezvous/index.html.twig', ['rendezvouses' => $rendezvousRepository->findAll()]);
    }
    ...
    {
        return $this->render('rendezvous/show.html.twig', ['rendezvous' => $rendezvous]);
    }
    ...
    public function edit(Request $request, Rendezvous $rendezvous): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('rendezvous_edit', ['id' => $rendezvous->getId()]);
        }
